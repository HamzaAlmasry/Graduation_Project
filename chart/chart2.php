...
<head>
    ...
    <title>ميزو كار لتاكيد الاضافة الي سلة التاجير</title>
...
<div class="chart-App back-color">
   ...
   <table class='content-table'>
    ...
    <div class="chart-item back-color">
            ...
            <div class="chart" >
                <form action="insert_rent.php" method="post">
                    <h2>هل تريد فعلا تاجير سيارة</h2>
                    ...
                    <input class="inp" class="inp" type="text" name="typebrand" value='<?php  echo $data['typebrand'] ?>' >
                    <input type="date" name="date" value='<?php  echo $data['thedate'] ?>' >
