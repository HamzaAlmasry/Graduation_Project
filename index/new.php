...
<head>
    ...
    <title>ميزو كار للعربيات الجديدة</title>
...
<div class="new-content back-content">
    <h1 class="back-color">موقع <span class="span1">ميزو كار</span> يوفر لكم احدث العربيات الجديدة</h1>
    ...
    <?php
             ...
             while($row = mysqli_fetch_array($result)){
                ...
                if(($row['condition'] === 'جديده') && ($row['typebrand'] === 'معروض للبيع')){
                echo "
                <div class='Car-flex'>
